...
import com.orienteering.startref.ui.competitors.CompetitorSearchScreen
    ...
    Scaffold(
        bottomBar = {
            NavigationBar {
                ...
                NavigationBarItem(
                    selected = currentDestination?.hierarchy?.any { it.route == "competitors" } == true,
                    onClick = {
                    ...
                    icon = { Icon(Icons.Default.PersonSearch, contentDescription = "Competitors") },
